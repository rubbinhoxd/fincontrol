...
public class EmailService {
    ...
    public void sendInactivityReminder(String toEmail, String toName, String unsubscribeToken) {
        String dashboardLink = frontendUrl + "/";
        String unsubscribeLink = frontendUrl + "/unsubscribe?token=" + unsubscribeToken;
        send(toEmail, "Sumiu, hein? 👀",
                buildInactivityReminderHtml(toName, dashboardLink, unsubscribeLink),
    ...
    private String buildInactivityReminderHtml(String name, String dashboardLink, String unsubscribeLink) {
        return """
                <!DOCTYPE html>
                <html>
                        ...
                        <tr>
                          <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 24px;color:#374151;font-size:16px;line-height:1.6;">
                              Faz uns dias que você não cadastra nada por aqui. Rolou algum gasto que passou batido?
                              Melhor lançar enquanto tá fresco na memória —
                              <strong>cada dia que passa aumenta a chance de esquecer, e despesa esquecida vira mistério no fim do mês.</strong>
                            </p>
                            ...
                            <p style="margin:24px 0 0;color:#6B7280;font-size:14px;line-height:1.6;font-style:italic;">
                              Mais rápido ainda: manda uma mensagem no WhatsApp que o Savey cadastra pra você.
                              <span style="color:#374151;">"Almocei 25 no restaurante"</span> já resolve.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          <td style="background:#F9FAFB;padding:20px 40px;text-align:center;">
                            ...
                            <p style="margin:0;color:#9CA3AF;font-size:12px;">
                              ...
                              <a href="%s" style="color:#10B981;text-decoration:underline;">Desativar</a>
                            </p>
                          </td>
                        </tr>
                      </table>
